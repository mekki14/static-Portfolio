...
const HeroSection = () => {
  return (
    ...
    <div class=" flex justify-center h- flex-col  py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
       
        <h1 class="mb-10 mt-32 px-8 text-7xl md:leading-tight font-extrabold tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white"><span className='text-blue-700'>مرحبا ,انا فيصل مطور</span> تطبيقات الويب</h1>
