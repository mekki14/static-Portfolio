...
const PortfolioSection = () => {
  return (
    <section
      dir="rtl"
      id="portfolio"
      class="bg-white px-10 my-8 flex justify-center items-center flex-col dark:bg-gray-900 text-center"
    >
      ...
      <div class=" hidden  flex-row items-center max-w-5xl mb-6 text-center bg-black  rounded-lg   dark:bg-gray-800 dark:border-gray-700 md:flex transition hover:scale-105">
        <img
      ...
      <div class=" hidden  flex-row items-center max-w-5xl mb-6 text-center bg-white  rounded-lg border dark:bg-gray-800 dark:border-gray-700 md:flex transition hover:scale-105">
        <img
          class="object-cover h-72 w-96 md:h-56 md:w-80 rounded-r-md "
          src={ProjectImg02}
          alt=""
      ...
      <div class=" hidden  flex-row items-center max-w-6xl mb-6 text-center  rounded-lg   dark:bg-gray-800 dark:border-gray-700 md:flex transition hover:scale-105" style={{backgroundColor:'#FCF2EC'}}>
        <img
